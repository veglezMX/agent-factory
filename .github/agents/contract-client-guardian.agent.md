...
argument-hint: A bundle task or bounded direct request describing the API surface, plus affected contracts/clients/mocks and any approved UI data-to-UI mapping that depends on it.
