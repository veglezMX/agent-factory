...
argument-hint: The stabilized product surfaces and user journeys to instrument, plus the packet sections that define the product's goals (§1, §3, §4, §13) and its privacy/consent rules (§9).
